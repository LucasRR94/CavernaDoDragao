...
public class Room 
{
    ...
    public void changeDescription(String description){ //**elemento inserido para facilitar a mudança uma vez que tenha sido declarado vetores ao inves de variaveis comuns*/
        this.description = description;
    }
